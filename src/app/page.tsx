        ...
        <div className="yw-container relative">
          ...
          <div className="mx-auto max-w-[680px] pb-14 pt-8 text-center lg:max-w-[620px] lg:pb-0 lg:pt-[430px]">
            ...
            <h1
              ...
              className="yw-enter mt-5 text-[36px] font-extrabold leading-[1.06] tracking-[-0.035em] text-ink sm:text-[48px] lg:mt-6 lg:text-[64px]"
            >
              Yoshlar haqida.{" "}
            ...
            <p
              ...
              className="yw-enter mx-auto mt-6 max-w-[520px] text-[15px] leading-[1.75] text-ink-2 lg:text-[16px]"
            >
            ...
            <div
              ...
              className="yw-enter mt-8 flex flex-col items-center gap-5 sm:flex-row sm:justify-center sm:gap-8"
            >
              <ButtonLink href="/yoshlar" size="lg" className="yw-press">
              ...
              <Link
                ...
                className="yw-press inline-flex items-center gap-3 text-[15px] font-semibold text-ink transition-all hover:gap-4 hover:text-accent-text"
              >
                Qanday ishlaydi?
      ...
      <section className="yw-container mt-10 lg:mt-24">
        ...
        <div className="mt-4 grid grid-cols-4 gap-2.5 lg:hidden">
          {tileCategories.map((category, index) => (
            <Reveal key={category.id} delay={index * 55}>
        ...
        <section className="yw-container mt-14 lg:mt-24">
          ...
          <div className="mt-5 grid grid-cols-2 gap-4 md:grid-cols-3 lg:grid-cols-4">
            {featured.items.slice(0, 4).map((candidate, index) => (
              <Reveal key={candidate.id} delay={index * 70}>
                <CandidateCard candidate={candidate} priority={index === 0} />
              </Reveal>
            ))}
          </div>
        </section>
      ...
      <section className="yw-container mt-14 lg:mt-24">
        <Reveal className="relative overflow-hidden rounded-panel border border-line bg-surface px-6 py-10 text-center sm:px-10 lg:py-14">
          ...
          <div className="relative mx-auto max-w-[560px]">
            ...
            <ButtonLink href="/ariza" size="lg" className="yw-press mt-7">
              Ariza yuborish
              <ArrowRight className="size-[18px]" />
            </ButtonLink>
          </div>
